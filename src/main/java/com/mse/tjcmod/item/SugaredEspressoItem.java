...
public class SugaredEspressoItem extends MseTjcmodModElements.ModElement {
	@ObjectHolder("mse_tjcmod:sugared_espresso")
	public static final Item block = null;
	public SugaredEspressoItem(MseTjcmodModElements instance) {
		super(instance, 3);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("sugared_espresso");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Sugared Espresso is a small, strong, and sweet Coffee."));
		}
