...
public class EmptyCoffeeFilterItem extends MseTjcmodModElements.ModElement {
	@ObjectHolder("mse_tjcmod:empty_coffee_filter")
	public static final Item block = null;
	public EmptyCoffeeFilterItem(MseTjcmodModElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("empty_coffee_filter");
		}
