...
public class CoffeeSaplingBlock extends MseTjcmodModElements.ModElement {
	@ObjectHolder("mse_tjcmod:coffee_sapling")
	public static final Block block = null;
	public CoffeeSaplingBlock(MseTjcmodModElements instance) {
		super(instance, 29);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("mse_tjcmod:coffee_jungle")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("coffee_sapling");
		}
